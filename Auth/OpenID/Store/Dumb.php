 ...
 * @package OpenID
 */
class Dumb extends \Auth\OpenID\Store {

    /**
     * Creates a new {@link \Auth\OpenID\DumbStore} instance. For the security
     ...
     * difficult to guess.
     *
     * Each {@link \Auth\OpenID\DumbStore} instance that is created for use by
    ...
    {
        $this->auth_key = \Auth\OpenID\SHA1($secret_phrase);
    }
